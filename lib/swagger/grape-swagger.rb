...
module Grape
  class API
          ...
          def self.setup(options)
            ...
            get @@mount_path do
              ...
              end
              {
                ...
                swaggerVersion: "1.1",
                basePath: "http"+(base_path || request.base_url),
                operations:[],
                apis: routes_array
              }
            end
    ...
    _models_hash.merge!(route.route_rc) unless route.route_rc.blank?
    operations.merge!({:responseClass => route.route_rc.keys[0]}) unless route.route_rc.blank?
